...
plt.plot(pc_im, sw_im, 'k-o', label=name, linewidth=4, markersize=12)
plt.plot(pc_eq[0:-2], sw_eq[0:-2], 'b-^', label="SNOW", linewidth=4, markersize=12)
plt.plot([x_im_at_0, x_im_at_1], [0, 1], 'r--', linewidth=4, markersize=12)
plt.plot([x_eq_at_0, x_eq_at_1], [0, 1], 'r--', label="Tangent (Equivalent)", linewidth=4, markersize=12)
